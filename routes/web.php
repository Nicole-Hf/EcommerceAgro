...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => 'categorias'], function () {
        Route::get
        ('/index', [App\Http\Controllers\CategoriaController::class, 'index'])
        ...
        Route::group(['prefix' => 'subcategorias'], function () {
            Route::get
            ('/index', [App\Http\Controllers\SubcategoriaController::class, 'index'])
                ->name('subcategorias.index');
            Route::get
            ('/create', [App\Http\Controllers\SubcategoriaController::class, 'create'])
                ->name('subcategorias.create');
            Route::get
            ('/{id}', [App\Http\Controllers\SubcategoriaController::class, 'show'])
                ->name('subcategorias.show');
            Route::get
            ('/{id}/edit', [App\Http\Controllers\SubcategoriaController::class, 'edit'])
                ->name('subcategorias.edit');
            Route::put
            ('/{id}', [App\Http\Controllers\SubcategoriaController::class, 'update'])
                ->name('subcategorias.update');
            Route::delete
            ('/{id}', [App\Http\Controllers\SubcategoriaController::class, 'destroy'])
    ...
    Route::group(['prefix' => 'empresas'], function () {
        Route::get
        ('/index', [App\Http\Controllers\EmpresaController::class, 'index'])
            ->name('empresas.index');
        Route::get
        ('/create', [App\Http\Controllers\EmpresaController::class, 'create'])
            ->name('empresas.create');
        Route::get
        ('/{id}', [App\Http\Controllers\EmpresaController::class, 'show'])
            ->name('empresas.show');
        Route::get
        ('/{id}/edit', [App\Http\Controllers\EmpresaController::class, 'edit'])
            ->name('empresas.edit');
        Route::put
        ('/{id}', [App\Http\Controllers\EmpresaController::class, 'update'])
            ->name('empresas.update');
        Route::delete
        ('/{id}', [App\Http\Controllers\EmpresaController::class, 'destroy'])
