                        ...
                        <div class="product_header">
                            <div class="product_header_left">
                                <div class="custom_select">
                                    <select class="form-control form-control-sm submit-form-on-change" name="sort-by"
                                        id="sort-by">
                ...
                <span data-color="#5FB7D4" style="background-color: rgb(95, 183, 212);"></span>
                                ...
                                <div class="list_product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        ...
                                        <li class="add-to-cart"><a class="add-to-cart-button" data-id="1" href="#"
                                                data-url="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
